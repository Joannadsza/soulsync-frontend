...
const features = [
  ...
  description:
    "Your therapy sessions are protected with JWT authentication and securely stored in an encrypted database, accessible only by you.",
  },
  {
  ...
  description:
    "Your emotional state is automatically analyzed during every therapy session, giving you real-time mood insights on your dashboard.",
  },
  {
